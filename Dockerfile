...
ARG NEXT_PUBLIC_HCLAW_POLICY_ADDRESS_MAINNET=""
ARG NEXT_PUBLIC_HCLAW_POLICY_ADDRESS_TESTNET=""
ARG NEXT_PUBLIC_MONAD_MAINNET_HCLAW_POLICY_ADDRESS=""
ARG NEXT_PUBLIC_MONAD_TESTNET_HCLAW_POLICY_ADDRESS=""
ARG NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS=""
ARG NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS_MAINNET=""
ARG NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS_TESTNET=""
ARG NEXT_PUBLIC_MONAD_MAINNET_HCLAW_REWARDS_ADDRESS=""
ARG NEXT_PUBLIC_MONAD_TESTNET_HCLAW_REWARDS_ADDRESS=""
ARG NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS=""
ARG NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS_MAINNET=""
ARG NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS_TESTNET=""
ARG NEXT_PUBLIC_MONAD_MAINNET_AGENTIC_LP_VAULT_ADDRESS=""
ARG NEXT_PUBLIC_MONAD_TESTNET_AGENTIC_LP_VAULT_ADDRESS=""
...
ENV NEXT_PUBLIC_HCLAW_POLICY_ADDRESS_MAINNET="${NEXT_PUBLIC_HCLAW_POLICY_ADDRESS_MAINNET}"
ENV NEXT_PUBLIC_HCLAW_POLICY_ADDRESS_TESTNET="${NEXT_PUBLIC_HCLAW_POLICY_ADDRESS_TESTNET}"
ENV NEXT_PUBLIC_MONAD_MAINNET_HCLAW_POLICY_ADDRESS="${NEXT_PUBLIC_MONAD_MAINNET_HCLAW_POLICY_ADDRESS}"
ENV NEXT_PUBLIC_MONAD_TESTNET_HCLAW_POLICY_ADDRESS="${NEXT_PUBLIC_MONAD_TESTNET_HCLAW_POLICY_ADDRESS}"
ENV NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS="${NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS}"
ENV NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS_MAINNET="${NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS_MAINNET}"
ENV NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS_TESTNET="${NEXT_PUBLIC_HCLAW_REWARDS_ADDRESS_TESTNET}"
ENV NEXT_PUBLIC_MONAD_MAINNET_HCLAW_REWARDS_ADDRESS="${NEXT_PUBLIC_MONAD_MAINNET_HCLAW_REWARDS_ADDRESS}"
ENV NEXT_PUBLIC_MONAD_TESTNET_HCLAW_REWARDS_ADDRESS="${NEXT_PUBLIC_MONAD_TESTNET_HCLAW_REWARDS_ADDRESS}"
ENV NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS="${NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS}"
ENV NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS_MAINNET="${NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS_MAINNET}"
ENV NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS_TESTNET="${NEXT_PUBLIC_AGENTIC_LP_VAULT_ADDRESS_TESTNET}"
ENV NEXT_PUBLIC_MONAD_MAINNET_AGENTIC_LP_VAULT_ADDRESS="${NEXT_PUBLIC_MONAD_MAINNET_AGENTIC_LP_VAULT_ADDRESS}"
ENV NEXT_PUBLIC_MONAD_TESTNET_AGENTIC_LP_VAULT_ADDRESS="${NEXT_PUBLIC_MONAD_TESTNET_AGENTIC_LP_VAULT_ADDRESS}"
